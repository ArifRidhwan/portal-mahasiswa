            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="integer" name="npm" value="{{ Auth::User()->npm}}" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        {{-- <a href="{{route('profile.edit')}}" class="btn-btn-outline-info"> Edit Data </a> --}}
                    </div>
                    <td>
                                {{-- <a href="{{ route('profile.edit', $profile->id) }}" class = "btn btn-success">Edit</a> --}}
                            </td>
                    </div>
            </div>
        </div>
